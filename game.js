const Game = {
    ...
    start() {
        ...
        this.interval = setInterval(() => {
            ...
            if (this.score === 1000) this.finalBoss = new FinalBoss(this.ctx, this.width, this.height,);
    ...
    reset() {
        ...
        if (this.gameOverSound) this.gameOverSound.pause();

        this.background = new Background(this.ctx, this.width, this.height, './img/sky.png');
        this.player = new Player(this.ctx, this.width, this.height, this.keys,);

        this.lives = this.MAX_LIVES;
        this.finalBossLives = this.MAX_LIVES_BOSS
    ...
    collisionPlayerEnemy() {
        ...
        this.enemies.forEach((en) => {
            if (this.player.posX + 10 < en.posX + 10 + en.width - 10 && this.player.posX + 10 + this.player.width - 10 > en.posX + 10 && this.player.posY + 10 < en.posY + 10 + en.height - 10 && this.player.posY + 10 + this.player.height - 10 > en.posY + 10) {
    ...
    collisionPlayerAsteroid() {
        ...
        this.asteroids.forEach((asteroid) => {
            if (this.player.posX + 10 < asteroid.posX + 10 + asteroid.width - 10 && this.player.posX + 10 + this.player.width - 10 > asteroid.posX + 10 && this.player.posY + 10 < asteroid.posY + 10 + asteroid.height - 10 && this.player.posY + 10 + this.player.height - 10 > asteroid.posY + 10) {
    ...
    collisionBulletsEnemies() {
        ...
        this.player.bullets.forEach((bullet) => {
            this.enemies.forEach((enemy, i) => {
                if (bullet.posX + 5 < enemy.posX + 5 + enemy.width - 5 && bullet.posX + 5 + bullet.width - 5 > enemy.posX + 5 && bullet.posY + 5 < enemy.posY + 5 + enemy.height - 5 && bullet.posY + 5 + bullet.height - 5 > enemy.posY + 5) {
    ...
    collisionPlayerBullet() {
        ...
        this.enemies.forEach(enemy => enemy.bullets.forEach((enemyBullet) => {
            if (enemyBullet.enemyPosX < this.player.posX + this.player.width - 5 && enemyBullet.enemyPosX + enemyBullet.width > this.player.posX + 5 && this.player.posY + 10 < enemyBullet.enemyPosY + enemyBullet.height && this.player.posY + this.player.height - 5 > enemyBullet.enemyPosY) {
    ...
    collisionPlayerPowershot() {
        ...
        this.powerShots.forEach((coffee, i) => {
            if (this.player.posX + 10 < coffee.posX + 10 + coffee.width - 10 && this.player.posX + 10 + this.player.width - 10 > coffee.posX + 10 && this.player.posY + 10 < coffee.posY + 10 + coffee.height - 10 && this.player.posY + 10 + this.player.height - 10 > coffee.posY + 10) {
    ...
    collisionPlayerHeart() {
        ...
        this.hearts.forEach((heart, i) => {
            if (this.player.posX + 10 < heart.posX + 10 + heart.width - 10 && this.player.posX + 10 + this.player.width - 10 > heart.posX + 10 && this.player.posY + 10 < heart.posY + 10 + heart.height - 10 && this.player.posY + 10 + this.player.height - 10 > heart.posY + 10) {
    ...
    collisionPlayerFinalBossBullet() {
        ...
        this.finalBoss?.bullets.forEach((bossBullet) => {
            if (bossBullet.enemyPosX < this.player.posX + this.player.width - 5 && bossBullet.enemyPosX + bossBullet.width > this.player.posX + 5 && this.player.posY + 10 < bossBullet.enemyPosY + bossBullet.height && this.player.posY + this.player.height - 5 > bossBullet.enemyPosY) {
                this.collisionSound.play();
                this.lives -= 1;
            }
        });
    ...
    collisionPlayerBulletsBoss() {
        ...
        this.player?.bullets.forEach((bullet) => {
            if (this.finalBoss && bullet.posX < this.finalBoss.posX + this.finalBoss.width && bullet.posX + bullet.width > this.finalBoss.posX && bullet.posY < this.finalBoss.posY + this.finalBoss.height && bullet.posY + bullet.height > this.finalBoss.posY) {

                this.explosionSound.play();
                this.finalBossLives -= 1;

                if (this.finalBossLives <= 0) {
                    this.player.bullets = []
